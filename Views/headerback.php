...
<head>
    ...
    <link rel="stylesheet" href="back/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="back/assets/css/jquery-ui.min.css">
    <link rel="stylesheet" href="back/assets/css/perfect-scrollbar.min.css">
    <link rel="stylesheet" href="back/assets/css/morris.min.css">
    <link rel="stylesheet" href="back/assets/css/select2.min.css">
    <link rel="stylesheet" href="back/assets/css/jquery-jvectormap.min.css">
    <link rel="stylesheet" href="back/assets/css/horizontal-timeline.min.css">
    <link rel="stylesheet" href="back/assets/css/weather-icons.min.css">
    <link rel="stylesheet" href="back/assets/css/dropzone.min.css">
    <link rel="stylesheet" href="back/assets/css/ion.rangeSlider.min.css">
    <link rel="stylesheet" href="back/assets/css/ion.rangeSlider.skinFlat.min.css">
    <link rel="stylesheet" href="back/assets/css/datatables.min.css">
    <link rel="stylesheet" href="back/assets/css/fullcalendar.min.css">
...
<body>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown nav-language">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="">
                                    <img src="back/assets/img/flags/de.png" alt="">
                                    <span>German</span>
                                </a>
                            </li>
                            <li>
                                <a href="">
                                    <img src="back/assets/img/flags/fr.png" alt="">
                                    <span>French</span>
                                </a>
                            </li>
                            <li>
                                <a href="">
                                    <img src="back/assets/img/flags/us.png" alt="">
                                    <span>English</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item dropdown nav--user online">
                        <a href="#" class="nav-link" data-toggle="dropdown">
                            <img src="back/assets/img/avatars/01_80x80.png" alt="" class="rounded-circle">
    ...
    <script src="back/assets/js/raphael.min.js"></script>
    <script src="back/assets/js/morris.min.js"></script>
    <script src="back/assets/js/select2.min.js"></script>
    <script src="back/assets/js/jquery-jvectormap.min.js"></script>
    <script src="back/assets/js/jquery-jvectormap-world-mill.min.js"></script>
    <script src="back/assets/js/horizontal-timeline.min.js"></script>
    <script src="back/assets/js/jquery.validate.min.js"></script>
    <script src="back/assets/js/jquery.steps.min.js"></script>
    <script src="back/assets/js/dropzone.min.js"></script>
    <script src="back/assets/js/ion.rangeSlider.min.js"></script>
